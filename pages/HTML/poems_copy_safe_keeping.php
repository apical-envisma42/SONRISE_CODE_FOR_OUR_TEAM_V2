...
<section class="blog-container" id="SECTION_POEMS">
    ...
    <div class="blog-card poem-card" data-genre="love" data-slug="I-sat-at-the-sea" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="sad" data-slug="Broken-clock" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="nature" data-slug="Whispers-of-rain" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="fantasy" data-slug="Moonlight-dreams" onclick="openPoem(this)">
...
<div class="blog-card poem-card" data-genre="Horror" data-slug="Shadows-In-The-Night" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="Adventure" data-slug="Beyond-The-Horizon" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="Love" data-slug="Roses-after-rain" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="Fantasy" data-slug="The-crystal-kingdom" onclick="openPoem(this)">
    ...
    <div class="blog-card poem-card" data-genre="Sad" data-slug="The-empty-bench" onclick="openPoem(this)">
...
<div class="blog-card poem-card" data-genre="Nature" data-slug="Forest-symphony" onclick="openPoem(this)">
...
<div class="blog-card poem-card" data-genre="Adventure" data-slug="Across-the-gloden-dunes" onclick="openPoem(this)">
    ...
    <div class="blog-content">
        ...
        <p>
        <?php 
        $text = "Across the dunes beneath the sun,
            ...
            $safe_text2 = xss_protect($text);
            echo nl2br($safe_text2);
        ?>
        </p>
...
<div class="blog-card poem-card" data-genre="Adventure" data-slug="The-last-voyage" onclick="openPoem(this)">
    ...
    <div class="blog-content">
        ...
        <p>
        <?php 
        $text = "The waves crashed hard against the shore,
...
Lay hidden lands few souls would know.";
            $safe_text = xss_protect($text);
            // REMOVED nl2br here to fix the staggered alignment
