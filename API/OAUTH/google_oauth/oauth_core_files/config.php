...
define('ROOT_PATH_OAUTH_API', '/../../../../');
require_once __DIR__ . '/session_init.php';
require_once __DIR__ . '/../oauth_logic/functions.php';
require_once __DIR__ . ROOT_PATH_OAUTH_API . 'vendor/autoload.php';

use Dotenv\Dotenv;

$dotenv = Dotenv::createImmutable(__DIR__ . ROOT_PATH_OAUTH_API);
$dotenv->load();
